 ...
 */
@objcMembers public class CocoaMQTT: NSObject, CocoaMQTTClient, CocoaMQTTDeliverProtocol {
    ...
    public func selfSignedSSLSetting()
    {
//        mqtt = CocoaMQTT(clientID: "Client", host: defaultHost, port: 8883)
        self.username = "vithamas"
        self.password = "vith@123"
//        self.willMessage = (CocoaMQTTMessage(topic: "/will", string: "dieout") as! CocoaMQTTWill)
        self.keepAlive = 60
//        self.delegate = self
        self.enableSSL = true
        self.allowUntrustCACertificate = true
        
        let clientCertArray = getClientCertFromP12File(certName: "client", certPassword: "vith@123")
...
//    //@discardableResult
    ...
    public  func getClientCertFromP12File(certName: String, certPassword: String) -> CFArray? {
        // get p12 file path
