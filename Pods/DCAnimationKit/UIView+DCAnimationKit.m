...
-(void)pulse:(DCAnimationFinished)finished
{
    [UIView animateWithDuration:0.2 animations:^{
        ...
        [UIView animateWithDuration:0.9 delay:0.1 options:0 animations:^{
...
-(void)bounceIntoView:(UIView*)view direction:(DCAnimationDirection)direction
{
    ...
    [self setDirection:direction];
    behavior.length = 0;
    behavior.damping = 0.15;
    behavior.frequency = 1.40;
    [animator addBehavior:behavior];
    
}
-(void)bounceIntoViewColorView:(UIView*)view direction:(DCAnimationDirection)direction
{
    if(self.superview != view)
        [self removeFromSuperview];
    [view addSubview:self];
...
-(void)bounceIntoViewAnother:(UIView*)view direction:(DCAnimationDirection)direction
{
    if(self.superview != view)
        [self removeFromSuperview];
    [view addSubview:self];
