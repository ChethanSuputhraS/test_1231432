...
- (void)selectCell
{
    if (_cellState == kCellStateCenter)
    {
        ...
        if (cellIndexPath)
        {
            [self.containingTableView selectRowAtIndexPath:cellIndexPath animated:YES scrollPosition:UITableViewScrollPositionNone];
...
- (void)centerView:(NSInteger)sender;
{
    [self.cellScrollView setContentOffset:CGPointMake(0, 0)];
}
- (void)rightUtilityButtonPress:(NSInteger)sender
{
    [self.cellScrollView setContentOffset:CGPointMake(180, 0)];

    

//    [self.cellScrollView setContentOffset:CGPointMake(180,0) animated:YES];
//    [self.cellScrollView setContentOffset:CGPointMake(180, 0)];
}
