...
//        self.fillColor = [UIColor clearColor];
        ...
        self.knobView.layer.cornerRadius = 14;
...
- (void) touchesEnded:(NSSet*)touches withEvent:(UIEvent*)event
{
    ...
    knobWidth.size.width = 28;
    knobWidth.size.height = 28;
...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    CGRect knobWidth = self.knobView.frame;
    knobWidth.size.width = 35;
    knobWidth.size.height = 35;
    self.knobView.frame = knobWidth;
    self.knobView.layer.cornerRadius = 17.5;
...
- (void)updateKnob
{
    ...
    _knobView.bounds = CGRectMake(0, 0, 30, 30);
