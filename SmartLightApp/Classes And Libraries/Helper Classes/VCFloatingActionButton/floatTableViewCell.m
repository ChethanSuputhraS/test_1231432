...
- (void)awakeFromNib
{
    // Initialization code
    overlay = [UIView new];
    overlay.backgroundColor = UIColor.redColor;   //[UIColor colorWithWhite:0.8 alpha:0.6];
...
//    self.title.backgroundColor = [UIColor colorWithWhite:0.8 alpha:0.8];
    self.title.layer.cornerRadius = 0;
    self.title.font = [UIFont fontWithName:CGRegular size:textSizes+5];
